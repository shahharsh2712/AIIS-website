...
export const metadata: Metadata = {
  ...
  description:
    "Age-appropriate AI literacy and projects for Grades 1–12 at AI Institute of Surat (AIIS).",
};

const bands = [
  {
    id: "g1-3",
    title: "Grades 1–3 · Discovery",
    topics: [
      "What is a “smart” tool vs a person?",
      "Pattern games and simple predictions",
      "Stories and art with AI assistance (teacher-led)",
      "Screen time and asking an adult",
    ],
    outcomes: "Curiosity and safe habits; early comfort with structured creativity.",
  },
  {
    id: "g4-5",
    title: "Grades 4–5 · Foundations",
    topics: [
      "Breaking problems into steps",
      "Introduction to data as “examples”",
      "Mini projects: quizzes, simple helpers",
      "Basics of bias: “the computer only knows what we show it”",
    ],
    outcomes: "Confidence with guided tools; teamwork and presentation skills.",
  },
  {
    id: "g6-8",
    ...
    <>
      <Section className="border-b border-[var(--color-aiis-border)] bg-[var(--color-aiis-surface)] pt-12 pb-16">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <a
            href={whatsappHref(
              `Hi ${site.shortName}, I'd like details on K-12 AI for grade: `,
            )}
            target="_blank"
